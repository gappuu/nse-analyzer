...
pub fn calculate_oi_rankings(data: &mut [OptionData]) {
...
pub fn find_atm_strike(data: &[OptionData], underlying_value: f64) -> f64 {
...
pub fn calculate_spread(data: &[OptionData], atm_strike: f64) -> f64 {
...
pub fn calculate_tambu(detail: &OptionDetail) -> Option<String> {
...
pub fn filter_strikes(processed: &mut Vec<ProcessedOptionData>, atm_strike: f64) {
...
pub fn get_max_oi(opt: &ProcessedOptionData) -> f64 {
