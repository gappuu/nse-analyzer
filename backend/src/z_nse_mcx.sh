...
echo "curl http://localhost:3001/nse_health"
echo "curl http://localhost:3001/api/nse/securities"
echo "curl 'http://localhost:3001/api/nse/contract-info?symbol=NIFTY'"
echo "curl -X POST http://localhost:3001/api/nse/batch-analysis"
echo ""

echo "# Test MCX APIs (port 3002)"
echo "curl http://localhost:3002/mcx_health"
...
echo "curl http://localhost/api/nse/securities        # → NSE server"
